jQuery('head').append('<style>.VE_Pushpin_Popup{position: absolute; z-index: 1000; display: none;}</style>');Microsoft.Maps.Pushpin.prototype.ToggleInfoBox=function(speed){if(this.GetInfoboxShown())this.HideInfobox(speed);else this.ShowInfobox(speed);};Microsoft.Maps.Pushpin.prototype.ShowInfobox=function(speed){if(!this._infoboxShown&&this._infoboxWrapper){speed=speed||'fast';var pos=this.tryLocationToPixel(this._location,Microsoft.Maps.PixelReference.control);this._infoboxWrapper.css('left',pos.x+'px').css('top',pos.y+'px').stop(true,true).fadeIn(speed);this._infoboxShown=true;}};Microsoft.Maps.Pushpin.prototype.HideInfobox=function(speed){if(this._infoboxShown){speed=speed||'fast';if(this._infoboxWrapper){this._infoboxWrapper.stop(true,true).fadeOut(speed);}
...
if(changed)Microsoft.Maps.Events.invoke(this,'entitychanged',{entity:this});this._setOptions(options);};Microsoft.Maps.Pushpin.prototype._mouseover=function(e){var entity=e.target;if(entity)entity.ShowInfobox();};Microsoft.Maps.Pushpin.prototype._mouseout=function(e){var entity=e.target;if(entity&&!entity._sticky&&!entity._autosticky)entity.HideInfobox();};Microsoft.Maps.Pushpin.prototype._click=function(e){var entity=e.target;if(entity){if(entity.GetInfoboxShown()){if(!entity._autosticky&&!entity._sticky){entity._autosticky=true;}else{entity._autosticky=false;entity.HideInfobox();}}else{entity._autosticky=true;entity.ShowInfobox();}}};Microsoft.Maps.EntityCollection.prototype._entityAdded=function(e){var entity=e.entity;if(entity instanceof Microsoft.Maps.Pushpin){var collection=e.collection;entity._infoboxShown=false;entity._autosticky=false;entity.tryLocationToPixel=collection._tryLocationToPixel;if(entity._infoboxWrapper){entity._infoboxWrapper.empty();entity._infoboxWrapper.remove();}
entity._infoboxWrapper=jQuery('<div class="VE_Pushpin_Popup"></div>');collection._rootElement.append(entity._infoboxWrapper);Microsoft.Maps.Events.addHandler(entity,'mouseover',entity._mouseover);Microsoft.Maps.Events.addHandler(entity,'mouseout',entity._mouseout);Microsoft.Maps.Events.addHandler(entity,'click',entity._click);collection._entityChanged(e);}};Microsoft.Maps.EntityCollection.prototype._entityChanged=function(e){var entity=e.entity;if(entity instanceof Microsoft.Maps.Pushpin){if(entity._infobox){if(entity._infoboxCustom){entity._infoboxWrapper.empty();}
...
entity._infoboxCustom=true;entity._infoboxWrapper.append(entity._infobox);}else if(entity._title||entity._description){if(entity._infoboxCustom){entity._infoboxWrapper.empty();entity._infoboxCustom=false;}
var title=(entity._title?entity._title:'');if(entity._infoboxTitle){entity._infoboxTitle.html(title);}else{entity._infoboxTitle=jQuery('<div class="Title">'+title+'</div>');entity._infoboxWrapper.append(entity._infoboxTitle);}
var description=(entity._description?entity._description:'');if(entity._infoboxDescription){entity._infoboxDescription.html(description);}else{entity._infoboxDescription=jQuery('<div class="Description">'+description+'</div>');entity._infoboxWrapper.append(entity._infoboxDescription);}}else{if(entity._infoboxWrapper){entity._infoboxWrapper.empty();}
entity._infoboxCustom=false;entity._infoboxTitle=false;entity._infoboxDescription=false;}}}
