...
Microsoft.Maps.EntityCollection.prototype._entityRemoved=function(e){var entity=e.entity;entity.tryLocationToPixel=null;if(entity._infoboxWrapper){entity._infoboxWrapper.empty();entity._infoboxWrapper.remove();entity._infoboxWrapper=null;}
Microsoft.Maps.Events.removeHandler(entity,'mouseover',entity._mouseover);Microsoft.Maps.Events.removeHandler(entity,'mouseout',entity._mouseout);Microsoft.Maps.Events.removeHandler(entity,'click',entity._click);Microsoft.Maps.Events.removeHandler(entity,'touchstart',entity._click);};Microsoft.Maps.Map.prototype._viewstart=function(){var viewreopen=this.target._viewreopen;var entities=this.target.entities;var l=entities.getLength();for(var i=0;i<l;i++){var entity=entities.get(i);if(entity.GetInfoboxShown()){if(entity._sticky||entity._autosticky)viewreopen.push(entity);entity.HideInfobox(1);}}}
Microsoft.Maps.Map.prototype._viewend=function(){var viewreopen=this.target._viewreopen;var l=viewreopen.getLength();for(var i=0;i<l;i++){viewreopen.pop().ShowInfobox();}}
Microsoft.Maps._Map=Microsoft.Maps.Map;Microsoft.Maps.Map=function(container,options){var map=new Microsoft.Maps._Map(container,options);map._viewreopen=new Microsoft.Maps.EntityCollection();map.entities._tryLocationToPixel=map.tryLocationToPixel;map.entities._rootElement=jQuery(map.getRootElement());Microsoft.Maps.Events.addHandler(map.entities,'entityadded',map.entities._entityAdded);Microsoft.Maps.Events.addHandler(map.entities,'entitychanged',map.entities._entityChanged);Microsoft.Maps.Events.addHandler(map.entities,'entityremoved',map.entities._entityRemoved);Microsoft.Maps.Events.addHandler(map,'viewchangestart',map._viewstart);Microsoft.Maps.Events.addHandler(map,'viewchangeend',map._viewend);return map;};